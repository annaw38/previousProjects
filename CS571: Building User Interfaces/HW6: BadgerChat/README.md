...
All data can be retrieved via API calls to `https://cs571api.cs.wisc.edu/rest/f25/hw6/`. A brief overview of the API is provided below. 

All routes are relative to `https://cs571api.cs.wisc.edu/rest/f25/hw6/`
