...
function calculateSubtotal() {
	let subtotal = 0.00;
	// loop over items to get quantity and price of each item
...
function calculateSalesTax() {
	...
	// console.log(getSalesTaxRateForState(state));
	// console.log(calculateSubtotal())
	salesTax = getSalesTaxRateForState(state) * calculateSubtotal();
...
document.getElementById("btn-checkout").addEventListener("click", () => {
	let total = calculateSubtotal() + calculateSalesTax();
