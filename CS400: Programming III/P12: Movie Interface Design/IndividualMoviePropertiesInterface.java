/**
 * Interface for class that defines a movie and exposes its movie properties
 * @author Anna Wang
 * 
 */
public interface IndividualMoviePropertiesInterface<T extends Comparable<T>> extends SortedCollectionInterface<KeyListInterface<T>>, Iterable<T>, IterableMultiKeySortedCollectionInterface<T> {
