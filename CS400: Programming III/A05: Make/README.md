...
file no longer up to date). 

Add another rule to your Makefile with the target "run", which depends on App.class, and a command 
...
command "make". Note that javac only runs when needed: when there is not already an up-to-date App.class file.
